...
python main.py -pt effnet6 -task ben_mal -it both -is 224 -btch 64 -ws -cval -frac 0.2 # all inputs
python main.py -pt effnet6 -task ben_mal -it both -is 224 -btch 64 -ws -cval # all inputs
python main.py -pt effnet6 -task ben_mal -it both -is 224 -btch 64 -ws -cval # all inputs
python main.py -pt effnet6 -task ben_mal -it both -is 224 -btch 64 -ws -cval # all inputs

python main.py -pt effnet6 -task ben_mal -it both -ncd -is 224 -btch 64 -ws -cval # only image
python main.py -pt effnet6 -task ben_mal -it both -ncd -is 224 -btch 64 -ws -cval # only image
python main.py -pt effnet6 -task ben_mal -it both -ncd -is 224 -btch 64 -ws -cval # only image
python main.py -pt effnet6 -task ben_mal -it both -ncd -is 224 -btch 64 -ws -cval # only image

python main.py -pt effnet6 -task ben_mal -it both -nit -is 224 -btch 64 -ws -cval # all inputs no image type
python main.py -pt effnet6 -task ben_mal -it both -nit -is 224 -btch 64 -ws -cval # all inputs no image type
python main.py -pt effnet6 -task ben_mal -it both -nit -is 224 -btch 64 -ws -cval # all inputs no image type
python main.py -pt effnet6 -task ben_mal -it both -nit -is 224 -btch 64 -ws -cval # all inputs no image type
