#python main.py -pt effnet6 -task nev_mel -it clinic -is 224 -btch 32 -opt adamax -ncd -loss focal -clrs 256 -mlrs 256 -l1 0. -l2 1e-6 -lr 1e-4 -dor 0.3  # 3 DONE
python main.py -pt effnet6 -task nev_mel -it both -is 224 -btch 32 -opt adamax -ncd -loss focal -ws -cv -clrs 256 -mlrs 256 -l1 0. -l2 1e-7 -lr 1e-4 -dor 0.2  # 4
