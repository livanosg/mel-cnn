...
TCMALLOC_RELEASE_RATE=8 LD_PRELOAD="/usr/lib/libtcmalloc.so"  python main.py -pt effnet6 -task ben_mal -it both -is 224 -btch 64 -ws -cval # all inputs
TCMALLOC_RELEASE_RATE=8 LD_PRELOAD="/usr/lib/libtcmalloc.so" python main.py -pt effnet6 -task ben_mal -it both -is 224 -btch 64 -ws -cval # all inputs
TCMALLOC_RELEASE_RATE=8 LD_PRELOAD="/usr/lib/libtcmalloc.so" python main.py -pt effnet6 -task ben_mal -it both -is 224 -btch 64 -ws -cval # all inputs
TCMALLOC_RELEASE_RATE=8 LD_PRELOAD="/usr/lib/libtcmalloc.so" python main.py -pt effnet6 -task ben_mal -it both -is 224 -btch 64 -ws -cval # all inputs

TCMALLOC_RELEASE_RATE=8 LD_PRELOAD="/usr/lib/libtcmalloc.so" python main.py -pt effnet6 -task ben_mal -it both -ncd -is 224 -btch 64 -ws -cval # only image
TCMALLOC_RELEASE_RATE=8 LD_PRELOAD="/usr/lib/libtcmalloc.so" python main.py -pt effnet6 -task ben_mal -it both -ncd -is 224 -btch 64 -ws -cval # only image
TCMALLOC_RELEASE_RATE=8 LD_PRELOAD="/usr/lib/libtcmalloc.so" python main.py -pt effnet6 -task ben_mal -it both -ncd -is 224 -btch 64 -ws -cval # only image
TCMALLOC_RELEASE_RATE=8 LD_PRELOAD="/usr/lib/libtcmalloc.so" python main.py -pt effnet6 -task ben_mal -it both -ncd -is 224 -btch 64 -ws -cval # only image

TCMALLOC_RELEASE_RATE=8 LD_PRELOAD="/usr/lib/libtcmalloc.so" python main.py -pt effnet6 -task ben_mal -it both -nit -is 224 -btch 64 -ws -cval # all inputs no image type
TCMALLOC_RELEASE_RATE=8 LD_PRELOAD="/usr/lib/libtcmalloc.so" python main.py -pt effnet6 -task ben_mal -it both -nit -is 224 -btch 64 -ws -cval # all inputs no image type
TCMALLOC_RELEASE_RATE=8 LD_PRELOAD="/usr/lib/libtcmalloc.so" python main.py -pt effnet6 -task ben_mal -it both -nit -is 224 -btch 64 -ws -cval # all inputs no image type
TCMALLOC_RELEASE_RATE=8 LD_PRELOAD="/usr/lib/libtcmalloc.so" python main.py -pt effnet6 -task ben_mal -it both -nit -is 224 -btch 64 -ws -cval # all inputs no image type
