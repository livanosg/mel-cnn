...
#python main.py -pt effnet6 -task nev_mel -it clinic -is 224 -btch 64 -ws -cval # all inputs done run 5x

python main.py -pt effnet6 -task nev_mel -it clinic -ncd -is 224 -btch 64 -ws -cval # run x2 times
