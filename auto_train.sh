...
#LD_PRELOAD="/usr/lib/libtcmalloc.so"
 python main.py -pt effnet6 -task ben_mal -it both -is 224 -btch 64 -ws -cval # all inputs
MALLOC_TRIM_THRESHOLD=0 python main.py -pt effnet6 -task ben_mal -it both -is 224 -btch 64 -ws -cval # all inputs
MALLOC_TRIM_THRESHOLD=0 python main.py -pt effnet6 -task ben_mal -it both -is 224 -btch 64 -ws -cval # all inputs
MALLOC_TRIM_THRESHOLD=0 python main.py -pt effnet6 -task ben_mal -it both -is 224 -btch 64 -ws -cval # all inputs

MALLOC_TRIM_THRESHOLD=0 python main.py -pt effnet6 -task ben_mal -it both -ncd -is 224 -btch 64 -ws -cval # only image
MALLOC_TRIM_THRESHOLD=0 python main.py -pt effnet6 -task ben_mal -it both -ncd -is 224 -btch 64 -ws -cval # only image
MALLOC_TRIM_THRESHOLD=0 python main.py -pt effnet6 -task ben_mal -it both -ncd -is 224 -btch 64 -ws -cval # only image
MALLOC_TRIM_THRESHOLD=0 python main.py -pt effnet6 -task ben_mal -it both -ncd -is 224 -btch 64 -ws -cval # only image

MALLOC_TRIM_THRESHOLD=0 python main.py -pt effnet6 -task ben_mal -it both -nit -is 224 -btch 64 -ws -cval # all inputs no image type
MALLOC_TRIM_THRESHOLD=0 python main.py -pt effnet6 -task ben_mal -it both -nit -is 224 -btch 64 -ws -cval # all inputs no image type
MALLOC_TRIM_THRESHOLD=0 python main.py -pt effnet6 -task ben_mal -it both -nit -is 224 -btch 64 -ws -cval # all inputs no image type
MALLOC_TRIM_THRESHOLD=0 python main.py -pt effnet6 -task ben_mal -it both -nit -is 224 -btch 64 -ws -cval # all inputs no image type
