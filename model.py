...
def model_fn(model_list, input_shape, dropout_rate, alpha):
    ...
    flat = keras.layers.Dense(2048, keras.layers.LeakyReLU(alpha=alpha))(flat)
    flat = keras.layers.BatchNormalization()(flat)
    flat = keras.layers.Dropout(rate=dropout_rate)(flat)
    flat = keras.layers.Dense(1024, activation=keras.layers.LeakyReLU(alpha=alpha))(flat)
    flat = keras.layers.BatchNormalization()(flat)
    flat = keras.layers.Dropout(rate=dropout_rate)(flat)
    flat = keras.layers.Dense(512, activation=keras.layers.LeakyReLU(alpha=alpha))(flat)
    flat = keras.layers.BatchNormalization()(flat)
    flat = keras.layers.Dropout(rate=dropout_rate)(flat)
    ...
    flat = keras.layers.BatchNormalization()(flat)
    flat = keras.layers.Dropout(rate=dropout_rate)(flat)
    img_fcl_2 = keras.layers.Dense(32, activation=keras.layers.LeakyReLU(alpha=alpha))(flat)
    ...
    fc_1 = keras.layers.Dense(1024, activation=keras.layers.LeakyReLU(alpha=alpha), )(concat_inputs)
    fc_1 = keras.layers.Dropout(rate=dropout_rate)(fc_1)
    fc_2 = keras.layers.Dense(512, activation=keras.layers.LeakyReLU(alpha=alpha))(fc_1)
    fc_2 = keras.layers.Dropout(rate=dropout_rate)(fc_2)
    fc_3 = keras.layers.Dense(265, activation=keras.layers.LeakyReLU(alpha=alpha))(fc_2)
    ...
    fc_5 = keras.layers.Dense(64, activation=keras.layers.LeakyReLU(alpha=alpha))(fc_4)
    fc_5 = keras.layers.Dropout(rate=dropout_rate)(fc_5)
    fc_6 = keras.layers.Dense(32, activation=keras.layers.LeakyReLU(alpha=alpha))(fc_5)
    fc_6 = keras.layers.Dropout(rate=dropout_rate)(fc_6)

    # -----------------------------================= Concat part =================---------------------------------#
    final_concat = keras.layers.Concatenate()([fc_6, img_fcl_2])
    fc_all = keras.layers.Dense(64, activation=keras.layers.LeakyReLU(alpha=alpha))(final_concat)
    fc_all = keras.layers.BatchNormalization()(fc_all)
    fc_all = keras.layers.Dropout(rate=dropout_rate)(fc_all)
    fc_all = keras.layers.Dense(64, activation=keras.layers.LeakyReLU(alpha=alpha))(fc_all)
    fc_all = keras.layers.BatchNormalization()(fc_all)
    fc_all = keras.layers.Dropout(rate=dropout_rate)(fc_all)
