...
def parser():
    ...
    args_parser.add_argument('--pretrained', '-pt', default='effnet1', choices=['incept', 'xept', 'effnet0', 'effnet1', 'effnet6'], help='Select pretrained model.')
    ...
    args_parser.add_argument('--learning-rate', '-lr', default=1e-4, type=float, help='Select learning rate.')
    ...
    args_parser.add_argument('--conv_layers', '-clrs', default=32, type=int, help='Select multiplier for number of nodes in inception layers.')
    args_parser.add_argument('--dense-layers', '-dlrs', default=4, type=int, help='Select multiplier for number of nodes in dense layers.')
    args_parser.add_argument('--merge-layers', '-mlrs', default=8, type=int, help='Select multiplier for number of nodes in merge layers.')
